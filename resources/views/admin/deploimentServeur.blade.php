...
<head>
  ...
  <title>Déploiement des serveurs</title>
...
<main class="bg-gray-100 p-4 flex-1">
    ...
    <section class="bg-white rounded-lg shadow-md p-4 flex flex-col">
      <h2 class="text-lg font-semibold mb-4">Choisir un serveur pour deployer</h2>
      <!-- Table -->
        ...
        <table class="w-full table-auto">
          <thead>
            <tr>
              ...
              <th class="px-4 py-2 text-left w-1/3">Adresse IP</th>
              ...
              <tr>
                ...
                <td class="px-4 py-2 border-b border-gray-200 w-1/3">
                  <label class="flex items-center">
                    ...
                    <span class="ml-2 text-gray-700">Gérer</span>
                  </label>
                </td>
              </tr>
              @endforeach
